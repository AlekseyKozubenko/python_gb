...
user_data = input("Введите строку из слов, разделенных пробелом, латиницей в нижнем регистре: ").split()
# print(user_data)
i = 0
for word in user_data:
    user_data.insert(i, int_func(user_data.pop(i)))
    i += 1

print(f"{' '.join(user_data)}")
